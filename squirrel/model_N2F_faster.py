...
##################### accelerated segmentation algorithm bg constant############################
    ...
    def rotation_invariance_step(self, mask, f):       
        f = torch.clone(torch.rot90(self.f))
        loss_mask=torch.round(torch.clone(torch.rot90(mask))).detach()
        ...
        self.rotation_list_mask = listimgH1_mask+listimgH2_mask+listimgV1_mask+listimgV2_mask
        self.rotation_list = listimgH1+listimgH2+listimgV1+listimgV2
